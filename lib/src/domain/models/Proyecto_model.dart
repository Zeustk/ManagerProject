...
ProyectoModel proyectosProviderFromJson(String str) =>
    ProyectoModel.fromJson(json.decode(str));

String proyectosProviderToJson(ProyectoModel data) =>
...
class ProyectoModel {
  ...
  factory ProyectoModel.fromJson(Map<String, dynamic> json) => ProyectoModel(
        ...
        porcentajeProyecto: json["PorcentajeProyecto"] is String
            ? double.parse(json["PorcentajeProyecto"])
            : json["PorcentajeProyecto"],
      );
